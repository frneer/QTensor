...
qconfig_uniform = {
        "conv2d"      : {"weights"    : {"kernel"    : UniformQuantizer(bits=8, signed=True )}},
        "conv2d_1"    : {"weights"    : {"kernel"    : UniformQuantizer(bits=8, signed=True )}},
        "dense"       : {"weights"    : {"kernel"    : UniformQuantizer(bits=8, signed=True )}},
        "dense_1"     : {"weights"    : {"kernel"    : UniformQuantizer(bits=8, signed=True )}},
        "dense_2"     : {"weights"    : {"kernel"    : UniformQuantizer(bits=8, signed=True )}},
        "activation"  : {"activations": {"activation": UniformQuantizer(bits=8, signed=False)}},
        "activation_1": {"activations": {"activation": UniformQuantizer(bits=8, signed=False)}},
        "activation_2": {"activations": {"activation": UniformQuantizer(bits=8, signed=False)}},
        "activation_3": {"activations": {"activation": UniformQuantizer(bits=8, signed=False)}},
        }
qconfig_flex = {
        "conv2d"      : {"weights"    : {"kernel"    : FlexQuantizer   (bits=8, n_levels=4, signed=True)}},
        "conv2d_1"    : {"weights"    : {"kernel"    : FlexQuantizer   (bits=8, n_levels=4, signed=True)}},
        "dense"       : {"weights"    : {"kernel"    : FlexQuantizer   (bits=8, n_levels=4, signed=True)}},
        "dense_1"     : {"weights"    : {"kernel"    : FlexQuantizer   (bits=8, n_levels=4, signed=True)}},
        "dense_2"     : {"weights"    : {"kernel"    : FlexQuantizer   (bits=8, n_levels=4, signed=True)}},
        "activation"  : {"activations": {"activation": UniformQuantizer(bits=8, signed=False)}},
        "activation_1": {"activations": {"activation": UniformQuantizer(bits=8, signed=False)}},
        "activation_2": {"activations": {"activation": UniformQuantizer(bits=8, signed=False)}},
        "activation_3": {"activations": {"activation": UniformQuantizer(bits=8, signed=False)}},
