...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Cuantización flexible de redes neuronales para compresión de modelos con “Quantization-Aware Training”} \\[1.5cm]
        ...
        \textbf{Director:} Dr. Ing. Federico Zacchigna \\[0.2cm]
        \textbf{Co-Directora:} Ing. Maria Celeste Corominas} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Juan Manuel Cruz (FIUBA)} \\
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Pablo Gómez (FIUBA)} \\
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Ricardo Veiga (FIUBA)} \\[2cm]
