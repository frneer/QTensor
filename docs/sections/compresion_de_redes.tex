La compresión de redes neuronales es también un proceso que consiste en reducir el tamaño de los datos, preservando lo mejor posible su performance. La misma, es usada tanto para reducir el espacio de almacenamiento necesario como el tiempo de inferencia. \\
