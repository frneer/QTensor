...
En este problema, no existe una solución cerrada para optimizar la función de costo, por lo que se deben emplear métodos numéricos iterativos. Entre estos métodos, destacan los algoritmos de optimización basados en utilizar el gradiente de la función de costo \cite{Nocedal2006}, los cuales serán detallados en la sección \ref{sec:algoritmos_de_optimizacion}.
