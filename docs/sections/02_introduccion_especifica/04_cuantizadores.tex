...
La función de cuantización uniforme puede escribirse como en la \refeq{uniform_quantizer}. El gráfico de la misma se muestra en la \reffig{uniform_signed}.
...
El cuantizador no uniforme es más versatil que el uniforme, ya que permite adaptar los niveles de cuantización a la distribución de los datos, lo que mejora la precisión de la cuantización y reduce la pérdida de información. Sin embargo, su implementación puede ser más compleja, especialmente en hardware de punto fijo, al tener valores incompatibles con aritmética de punto fijo.
...
El cuantizador flexible busca combinar las ventajas de los cuantizadores uniforme y no uniforme. Teniendo la eficiencia de implementacion del uniforme, y la versatilidad del no uniforme para adaptarse a diferentes distribuciones de datos. Consiste en cuantizar uniformemente los niveles de un cuantizador no uniforme.
...
Con $q_u$ siendo la funcion de cuantizacion uniforme definida en \refeq{uniform_quantizer}. El gráfico de la función de cuantización flexible se muestra en la \reffig{flexible_signed_q}.
