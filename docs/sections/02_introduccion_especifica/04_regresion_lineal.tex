...
En el caso general de la regresión lineal, se busca modelar la relación entre una variable dependiente $y$ y una o más variables independientes $x_j$ mediante una combinación lineal de estas últimas, como se muestra en \eqref{eq:linear_regression_multivariable}.
...
Una elección común para la métrica utilizada en problemas de regresión lineal es el error cuadrático medio explicado en la sección \ref{sec:metricas_regresion}, definida \eqref{eq:mse}. En este caso, la función de costo $\mathcal{L}$ a minimizar es directamente la métrica MSE, como se muestra \eqref{eq:mse_regression}.
