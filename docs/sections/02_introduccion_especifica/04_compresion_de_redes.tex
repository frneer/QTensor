...
La compresión de redes neuronales es también un proceso que consiste en reducir el tamaño de los datos, en particular, de una red neuronal. La compresión de modelos busca reducir su tamaño y complejidad, preservando lo mejor posible su rendimiento. Para reducir su tamaño y acelerar el tiempo de inferencia. \\
...
Cada técnica posee ventajas y desventajas y la elección de la técnica adecuada depende del caso de uso específico, el tipo de arquitectura del modelo y los requisitos de rendimiento\cite{mishra2020surveydeepneuralnetwork}.
