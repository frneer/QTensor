...
\begin{itemize}
    ...
    \item RF1.2: El sistema debe permitir una granularidad a nivel de atributo, posibilitando la asignación de cuantizadores distintos para cada parámetro del modelo. En particular, para todo peso y toda activación de cada capa, incluyendo capas con parámetros anidados (e.g. RNN \cite{tensorflow_keras_rnn}).
    ...
    \item RF1.4: El sistema debe soportar la serialización y deserialización \cite{tensorflow_serialization_guide} de modelos cuantizados (formato .keras o SavedModel), preservando el estado completo de los cuantizadores, incluyendo sus parámetros entrenables.
\end{itemize}
