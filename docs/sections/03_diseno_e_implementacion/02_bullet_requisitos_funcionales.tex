...
\begin{itemize}
    ...
    \item RF1.4: El sistema debe soportar la serialización y deserialización \cite{tensorflow_serialization_guide} de modelos cuantizados (formato .keras o SavedModel), inclusive el estado completo de los cuantizadores.
\end{itemize}
