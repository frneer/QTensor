...
La función de cuantización uniforme puede escribirse como en la \refeq{uniform_quantizer_signed}. El gráfico de la misma se muestra en la \reffig{uniform_signed}.
...
La derivada con respecto a los niveles $\frac{\partial q}{\partial l_i}$ también se aproxima utilizando STE, como se muestra en la \reffig{flexible_signed_dq_dl}. En este caso, para un $x$ fijo,

% TODO(frneer): Reemplazar con figura siguiendo el estilo de las otras.
...
\begin{equation}
\label{eq:flexible_quantizer_dq_dl}
\frac{\partial q}{\partial l_i} \left(x; \alpha, t, l\right) = \mathbbm{1}_{\left[t_i, t_{i+1}\right]} \left(x_j\right)
\end{equation}
...
\frac{\partial q}{\partial t_i} \left(x; \alpha, t, l\right) = \frac{l_{i-1} - l_i}{t_{i+1} - t_{i-1}}\mathbbm{1}_{\left[t_{i-1}, t_{i+1}\right]} \left(x_j\right)
\end{equation}
