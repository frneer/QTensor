...
Para realizar QAT es necesario definir los gradientes de las funciónes de cuantización con respecto a las entradas. Para implementar cuantizadores con parámetros entrenables, también es necesario definir los gradientes con respecto a sus parámetros. En esta sección se describen los gradientes definidos para los cuantizadores desarrollados en la sección \ref{sec:funciónes_de_cuantizacion}.
...
Por ende, la derivada $\frac{\partial q_u}{\partial x}$ se aproxima como en la \refeq{uniform_quantizer_ste_signed_derivative}.
