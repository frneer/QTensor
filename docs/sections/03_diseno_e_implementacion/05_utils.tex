...
La complejidad espacial de un modelo $S_{M}$ se calcula mediante la acumulación de la complejidad espacial de cada capa, como se muestra en \eqref{eq:space_complexity_model}, donde $N_{L}$ representa la cantidad de capas del modelo.
