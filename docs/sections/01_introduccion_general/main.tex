...
Esta herramienta permite explorar arquitecturas en punto fijo con aritmética arbitraria, ya sea uniforme, flexible o una combinación de ambas, lo que ofrece un mayor grado de adaptabilidad a las características del modelo y del hardware de destino.

Finalmente, otro aporte relevante es que los parámetros del cuantizador también son entrenables durante el proceso de QAT, lo que permite que la red se adapte dinámicamente al esquema de cuantización y optimice su desempeño durante el entrenamiento.
