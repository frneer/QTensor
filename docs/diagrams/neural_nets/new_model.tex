...
% Conv2 (128)
\draw  [fill=white  ,fill opacity=1 ] (220, 106.5) -- (274, 52.5) -- (284, 52.5) -- (284, 175.5) -- (230, 229.5) -- (220, 229.5) -- cycle ;
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ] (284, 52.5) -- (230, 106.5) -- (220, 106.5) ;
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ] (230, 106.5) -- (230, 229.5) ;
...
% Pool2
\draw  [color=red  ,draw opacity=1 ][fill=white  ,fill opacity=1 ] (290, 113.5) -- (324, 79.5) -- (334, 79.5) -- (334, 152.5) -- (300, 186.5) -- (290, 186.5) -- cycle ;
\draw  [color=red  ,draw opacity=1 ] (334, 79.5) -- (300, 113.5) -- (290, 113.5) ; \draw  [color=red  ,draw opacity=1 ] (300, 113.5) -- (300, 186.5) ;
\draw (305, 62.5) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize]  {$8\times 8\times 128$};

% Flatten Arrow
\draw    (340, 135) -- (360, 135) ;
\draw [shift={(360, 135)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
\draw (335, 110) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] {Flatten};
